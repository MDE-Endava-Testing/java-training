package homeworks.christian.seventAssignment;
...
public class DriversFactory {
    ...
    private static final Supplier<WebDriver> chromeSupplier = () -> {
        System.setProperty("webdriver.chrome.driver", "src\\main\\java\\homeworks\\christian\\seventhAssignment\\driver\\chromedriver.exe");
